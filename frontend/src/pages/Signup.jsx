                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="flex items-start animate-fade-in delay-100">
                            <input
                                ...
                                onChange={handleChange}
                                required
                                className="w-4 h-4 mt-1 text-[#06D6A0] bg-gray-50 border-gray-300 rounded focus:ring-2 focus:ring-[#06D6A0]"
                            />
                            <label htmlFor="agreeToTerms" className="ml-2 text-sm text-gray-600">
                                I agree to the{' '}
                                <a href="#" className="text-[#073B4C] hover:text-[#06D6A0] transition font-medium">
                                    Terms and Conditions
                                </a>{' '}
                                and{' '}
                                <a href="#" className="text-[#073B4C] hover:text-[#06D6A0] transition font-medium">
                        ...
                        <button
                            type="submit"
                            className="w-full py-3.5 bg-linear-to-r from-[#06D6A0] to-[#073B4C] text-white rounded-lg font-semibold shadow-lg hover:shadow-xl hover:scale-[1.02] hover:-translate-y-0.5 active:scale-[0.98] transition-all animate-fade-in delay-200"
                        >
                            Create Account
                        </button>
                        ...
                        <button
                            type="button"
                            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border-2 border-gray-200 rounded-lg hover:border-gray-300 hover:shadow-md hover:scale-[1.02] active:scale-[0.98] transition-all text-gray-700 font-medium animate-fade-in delay-300"
                        >
